...
<div class="container">
	...
	<form class="well form-horizontal" action="/patient/insert_patient" method="post"  id="registration_form">
	<fieldset>
	...
	<div class="form-group">
	  ...
	  <input name="ptcode" placeholder="Patient Number" class="form-control"  type="text">
		</div>
	</div>
	</div>
	...
	<div class="form-group">
	  <label class="col-md-4 control-label">Referral</label>  
	   <div class="col-md-4 inputGroupContainer">
		<div class="input-group">
			<span class="input-group-addon"><i class="fa fa-globe" aria-hidden="true"></i></span>
	  <input name="referral" placeholder="Please enter a referral" class="form-control" type="text">
		</div>
	  </div>
	</div>
